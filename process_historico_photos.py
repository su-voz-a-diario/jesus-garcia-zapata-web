...
input_dir = '/Volumes/Almacenamiento/jesus-garcia-zapata/Pinturas dos'
output_dir = '/Volumes/Almacenamiento/jesus-garcia-zapata/assets/images/obras'
...
for idx, img_path in enumerate(images, start=1):
    try:
        with Image.open(img_path) as img:
            ...
            output_path = os.path.join(output_dir, f'historico-{idx:02d}.webp')
            img.save(output_path, 'WEBP', quality=85)
            print(f"Optimized {os.path.basename(img_path)} -> historico-{idx:02d}.webp")
    except Exception as e:
